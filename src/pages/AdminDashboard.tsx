...
//     await axios.post("https://hostel-attendence-tg6k.onrender.com//api/admin/students", data, {
//       headers: {
  ...
  const fetchStudents = async () => {
    try {
      ...
      const res = await axios.get(
        "https://hostel-attendence-tg6k.onrender.com//api/admin/students",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
                      ...
                      <TableRow key={s._id}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-3">
                            ...
                            /> */}
                            {/* <img
  src={`https://hostel-attendence-tg6k.onrender.com/${s.photo}`}
  className="w-9 h-9 rounded-full"
/> */}
<img
  src={s.photo}
